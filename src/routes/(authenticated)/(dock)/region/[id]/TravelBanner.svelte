		...
		<div class="flex-1">
			...
			<div class="flex items-center gap-4 text-sm">
				<div class="flex items-center gap-2">
					<FluentClock20Filled class="size-4 text-[#f7c56b]" />
					<span class="text-[#fff7e8]">
						{#if hoursLeft > 0}
				...
				<div class="flex items-center gap-2">
					<FluentNavigation20Filled class="size-4 text-[#7ba0c8]" />
					<span class="text-[#fff7e8]">{activeTravel.distanceKm} km</span>
				</div>
			</div>
