                    ...
                    {#each data.analytics.categoryBreakdown.sort((a, b) => Math.abs(b.net) - Math.abs(a.net)) as cat}
                        ...
                        <div class="flex items-center justify-between py-1.5">
                            <div class="flex items-center gap-2">
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {color.bg} {color.border} border {color.text}">
                                ...
                                <div class="p-4 hover:bg-slate-700/20 transition-colors first:rounded-t-xl last:rounded-b-xl">
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <div class="flex items-start gap-3 flex-1 min-w-0">
                                            <div class="size-10 rounded-lg flex items-center justify-center shrink-0 {tx.isIncome ? 'bg-emerald-600/20' : 'bg-red-600/20'}">
                                                {#if tx.isIncome}
                                                    <FluentArrowDownload20Filled class="size-5 text-emerald-400" />
                                                {:else}
                                                    <FluentArrowUpload20Filled class="size-5 text-red-400" />
                                                {/if}
                                            </div>
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium {color.bg} {color.border} border {color.text}">
