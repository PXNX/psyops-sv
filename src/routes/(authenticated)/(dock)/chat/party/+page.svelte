	...
	<div class="max-w-5xl mx-auto px-4 py-6 h-[calc(100vh-8rem)] flex flex-col">
		...
		<div class="bg-slate-800/50 rounded-t-xl border border-white/5 p-4">
			<div class="flex items-center gap-3">
				...
				<div class="flex-1">
					...
					<p class="text-sm text-gray-400">{data.party.memberCount} members</p>
				</div>
			</div>
		</div>
				...
				{#each data.messages as msg}
					{#if msg.isFromCurrentUser}
						...
						<div class="chat chat-end">
							<div class="chat-bubble bg-emerald-600 text-white">
								{msg.content}
							</div>
		...
		<div class="bg-slate-800/50 rounded-b-xl border border-white/5 p-4">
			...
			>
				...
				<button
					type="submit"
					class="btn bg-emerald-600 hover:bg-emerald-700 border-0 text-white gap-2"
